...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Toko | kampuStore</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        /* ========== THEME VARIABLES (SAMA SPIRIT DENGAN MARKET/ADMIN) ========== */
        :root{
          --bg-body:#050b1f;
          --text-main:#e5e7eb;
        ...
        /* LIGHT MODE OVERRIDE – disamain feel-nya dengan Market/Admin */
        body.theme-light{
          --bg-body:#eef2ff;
          --text-main:#1a2550;
        ...
        .btn-primary{
          ...
          color:#111827;
          box-shadow:0 10px 22px rgba(248,113,22,.55);
        }
        .btn-primary:hover{
          transform:translateY(-1px);
          box-shadow:0 12px 26px rgba(248,113,22,.7);
        }
...
@php
    ...
    $user  = auth()->user();
    $seller = $user
        ? Seller::where('user_id', $user->id)->latest()->first()
        : null;
...
<nav class="nav">
    <div class="nav-left">
        ...
        <div class="nav-menu">
            ...
            <a href="{{ route('seller.dashboard') }}" class="active">Toko Saya</a>
        </div>
    </div>

    <div class="nav-search" style="max-width:260px;">
        <input type="text" placeholder="Cari produk (dummy)..." disabled>
    </div>
    ...
    <div class="header-right">
        ...
        <div class="account-wrapper" id="accountWrapper">
            ...
            <button class="icon-btn js-account-toggle" type="button" title="Akun Saya">
            ...
            <div class="account-menu" id="accountMenu">
                @auth
                    ...
                    <div class="profile-list">
                        <a href="{{ route('seller.dashboard') }}" class="profile-item">
...
{{-- AREA DASHBOARD SELLER --}}
<main class="admin-bg">
    <div class="admin-container">
        {{-- SIDEBAR --}}
        <aside class="admin-sidebar">
            <div>
                <div class="admin-sidebar-title">Toko Saya</div>
                <div class="admin-sidebar-sub">
                    Pantau status pengajuan dan kelola profil toko kamu.
                </div>
            </div>

            <div>
                <div class="admin-sidebar-section-title">Menu</div>
                <ul class="admin-menu">
                    <li>
                        <a href="{{ route('seller.dashboard') }}" class="admin-link active">
        ...
        <section class="admin-main">
            <div class="admin-top-meta">
                <div>
                    <div class="admin-top-left-title">
                        Dashboard Toko
                    </div>
                    <div class="admin-top-left-sub">
                        Lihat status pengajuan buka toko dan data toko kamu.
                    </div>
                </div>
            ...
            <div class="breadcrumb">
                Toko Saya &raquo; <span class="current">Dashboard</span>
            </div>
            ...
            @if(!$seller)
                <section class="panel">
                    <header class="panel-header">
                        <div>
                            <div class="panel-title">Belum punya toko</div>
                            <div class="panel-sub">
                                Ajukan buka toko untuk mulai jualan di kampuStore.
                            </div>
                        </div>
                    </header>

                    <p style="margin-bottom:12px;">
                        Kamu belum mengajukan pembukaan toko. Setelah pengajuan dikirim,
                        statusnya akan muncul di dashboard ini (pending / approved / rejected).
                    </p>

                    <a href="{{ route('seller.register') }}" class="btn-primary">
                        <i class="uil uil-store" style="margin-right:6px;"></i>
                        Ajukan Buka Toko Sekarang
                    </a>
                </section>
            @else
                {{-- SUDAH PUNYA PENGAJUAN TOKO --}}
                <section class="panel">
                    <header class="panel-header">
                        <div>
                            ...
                            <div class="panel-sub">
                                Informasi ringkas tentang status pengajuan buka toko kamu.
                            </div>
                        </div>
                        <span class="status-pill {{ $status }}">
                            {{ ucfirst($status) }}
                    ...
                    @if($status === 'pending')
                        <p style="margin-bottom:6px;">
                            Pengajuan buka toko kamu sedang <strong>diproses admin</strong>.
                        </p>
                        <p class="text-muted">
                            Admin akan meninjau data dan dokumen kamu. Jika disetujui, toko
                            akan aktif dan kamu bisa mulai upload produk. Jika ditolak,
                            alasan penolakan akan diinformasikan di sini.
                        </p>
                    @elseif($status === 'approved')
                        <p style="margin-bottom:6px;">
                            Selamat! Pengajuan buka toko kamu telah
                            <strong>disetujui (APPROVED)</strong>.
                        </p>
                        <p class="text-muted">
                            Kamu sudah bisa menggunakan akun ini sebagai seller di kampuStore.
                            (Halaman kelola produk bisa kamu tambahkan nanti sesuai kebutuhan.)
                        </p>
                    @elseif($status === 'rejected')
                        <p style="margin-bottom:6px;">
                            Pengajuan buka toko kamu <strong>ditolak (REJECTED)</strong>.
                        </p>
                        <p class="text-muted">
                            Silakan periksa kembali data yang kamu kirim. Jika perlu, kamu bisa
                            menghubungi admin atau mengajukan ulang dengan data yang sudah diperbaiki.
                        </p>
                    @else
                        <p class="text-muted">
                            Status toko tidak dikenali. Silakan hubungi admin.
                        </p>
                    @endif
                </section>
                ...
                <section class="panel">
                    <header class="panel-header">
                        <div>
                            <div class="panel-title">Data Toko</div>
                            <div class="panel-sub">
                                Informasi toko yang kamu ajukan ke kampuStore.
                            </div>
                        </div>
                    </header>
                    ...
                    <table class="stats-table">
                        ...
                        <tr>
                            ...
                            <td>{{ $seller->deskripsi_singkat }}</td>
                        </tr>
                        <tr>
                            <th>Nama PIC</th>
...
<script>
    // THEME TOGGLE – sama key dengan Market/Admin
    (function(){
