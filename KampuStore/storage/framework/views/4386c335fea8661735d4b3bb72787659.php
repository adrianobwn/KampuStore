    ...
    <main class="auth-bg">
        <div class="auth-shell pre-enter">
            ...
            <div class="auth-visual">
                <img src="<?php echo e(asset('images/pc.png')); ?>" alt="Forgot Password">
            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="auth-bottom-text">
                        <a href="<?php echo e(route('login')); ?>" id="goLogin">← Back to Login</a>
                    </div>
                </div>
            </div>
...
<?php /**PATH E:\laragon\www\KampuStore\KampuStore\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>