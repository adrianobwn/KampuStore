...
<body>
    ...
    <nav class="nav">
        <a href="<?php echo e(route('home')); ?>" class="nav-logo">kampuStore</a>
        <div class="nav-menu">
    ...
    <main class="auth-bg">
        <div class="auth-shell">
            ...
            <div class="auth-visual">
                <img src="<?php echo e(asset('images/auth/hero.jpg')); ?>" alt="kampuStore hero">
            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="auth-bottom-text">
                        ...
                        <a href="<?php echo e(route('login')); ?>" id="goLogin">Login here</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH E:\laragon\www\KampuStore\KampuStore\resources\views/auth/register.blade.php ENDPATH**/ ?>