      ...
      <div class="account-menu" id="accountMenu">
        ...
        @else
          <a href="{{ route('login') }}"
            ...
            <i class="uil uil-shop"></i> Login Penjual
          </a>

          <a href="{{ route('register') }}"
            class="custom-btn btn-auth-primary"
            style="margin:2px 10px 6px;">
            <i class="uil uil-store-alt"></i> Daftar Jadi Penjual
          </a>
        @endauth
      </div>
    </div>
    ...
    <main class="main-content">
      ...
      <div class="welcome-banner">
        ...
        @else
          ...
          <div class="welcome-sub">
            Belanja perlengkapan kampus dari mahasiswa UNDIP lain — langsung beli tanpa perlu login!
          </div>

          <div style="background:rgba(59,130,246,0.1);border:1px solid rgba(59,130,246,0.3);border-radius:12px;padding:12px 16px;margin-top:12px;font-size:13px;color:var(--text-main);">
            <strong style="color:#3b82f6;"><i class="uil uil-info-circle"></i> Ingin Berjualan?</strong><br>
            <span style="opacity:0.9;">Daftar sebagai penjual untuk mulai jualan di kampuStore!</span>
            <a href="{{ route('register') }}" style="display:inline-block;margin-top:8px;padding:6px 16px;background:#3b82f6;color:white;border-radius:8px;text-decoration:none;font-size:12px;font-weight:600;">
              Daftar Sekarang →
            </a>
          </div>
        @endauth
