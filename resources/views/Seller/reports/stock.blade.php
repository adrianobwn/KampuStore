...
<head>
    ...
    <title>Laporan Stok Produk - {{ $seller->nama_toko }} | kampuStore</title>
            ...
            <div class="hidden md:flex items-center gap-6">
                ...
                <div class="relative" x-data="{ openReports: false }">
                    ...
                    <div x-show="openReports" @click.away="openReports = false" class="absolute left-0 mt-2 w-56 rounded-lg shadow-lg bg-slate-800 border border-blue-500/30" style="display: none;">
                        <div class="py-2">
                            <a href="{{ route('seller.reports.stock') }}" class="block px-4 py-2 text-sm text-white bg-blue-500/10">
...
<main class="pt-24 pb-12 px-4">
    <div class="container mx-auto max-w-7xl">
        ...
        <div class="mb-6 fade-in">
            <h1 class="text-3xl font-bold text-white mb-2">Laporan Daftar Produk Berdasarkan Stock</h1>
        ...
        <div class="bg-slate-800/50 rounded-2xl border border-blue-500/30 p-6 mb-6 fade-in no-print">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('seller.reports.stock.export') }}" class="bg-green-600 text-white px-4 py-2.5 rounded-lg hover:bg-green-700 transition inline-flex items-center">
        ...
        <div class="bg-slate-800/50 backdrop-blur-lg rounded-2xl border border-blue-500/30 overflow-hidden fade-in">
            <div class="p-6 border-b border-blue-500/20">
                <h2 class="text-lg font-bold text-white">Daftar Produk (Urutan berdasarkan Stock)</h2>
            </div>
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-slate-700/50">
                        ...
                        <tr class="hover:bg-slate-700/30">
                            ...
                            <td class="px-6 py-4 text-sm text-yellow-400">{{ number_format($product->avg_rating, 2) }} ⭐</td>
                            <td class="px-6 py-4">
