...
<head>
    ...
    <style>
        ...
        * { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; box-sizing: border-box; }
        ...
        .alert-warning i { color:#ef4444;font-size:24px; }
        .alert-success { background:rgba(34,197,94,0.1);border:1px solid rgba(34,197,94,0.3); }
        .alert-success i { color:#22c55e;font-size:24px; }
        ...
        tr.critical td { background:rgba(239,68,68,0.05); }
        ...
        .empty-state i { font-size:64px;color:#22c55e;margin-bottom:16px; }
    ...
    <aside class="sidebar no-print">
        ...
        <div class="sidebar-section">
            ...
            <div class="sidebar-menu">
                ...
                <a href="{{ route('seller.reports.restock') }}" class="sidebar-link active">
                        ...
                        <tr class="{{ $product->stock == 0 ? 'critical' : '' }}">
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:8px;">
                                    @if($product->stock == 0)
                                        <i class="uil uil-ban pulse" style="color:#ef4444;"></i>
                                    @else
                                        <i class="uil uil-exclamation-triangle" style="color:#eab308;"></i>
                                    @endif
                            ...
                            <td>
                                @if($product->stock == 0)
                                    <span class="badge badge-red pulse">HABIS</span>
                                @else
                            ...
                            <td colspan="5">
                                <div class="empty-state">
                                    @if($totalProducts == 0)
                                        ...
                                        <p style="font-size:18px;font-weight:600;color:var(--text-muted);">Belum Ada Produk</p>
                                        <p>Tambahkan produk untuk mulai berjualan</p>
                                        <a href="{{ route('seller.products.create') }}" class="btn-action btn-primary" style="margin-top:12px;">
                                            <i class="uil uil-plus"></i> Tambah Produk
                                        </a>
                                    @else
                                        <i class="uil uil-check-circle"></i>
                                        <p style="font-size:18px;font-weight:600;color:#22c55e;">Semua Produk Aman!</p>
