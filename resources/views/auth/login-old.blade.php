    ...
    <div class="auth-shell pre-enter">
        ...
        <div class="auth-panel">
            <div class="auth-panel-inner">
                ...
                <h1 class="auth-title">Login Penjual</h1>
                <p class="auth-subtitle">
                    Masuk dengan akun penjual untuk mengelola toko dan produk di kampuStore.
                </p>
                <div style="background:rgba(59,130,246,0.1);border:1px solid rgba(59,130,246,0.3);border-radius:8px;padding:10px;margin-bottom:16px;font-size:12px;text-align:center;">
                    <strong style="color:#3b82f6;">ℹ️ Info:</strong> Login ini khusus untuk penjual. Pembeli bisa langsung belanja tanpa login di <a href="{{ route('products.index') }}" style="color:#3b82f6;text-decoration:underline;">halaman market</a>.
                </div>
                ...
                <div class="auth-bottom-text">
                    ...
                    <a href="{{ route('register') }}" id="goRegister">Daftar sekarang</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    // THEME TOGGLE (sinkron dengan halaman lain: key 'kampuStoreTheme')
    (function(){
