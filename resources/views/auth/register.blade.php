...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        /* ===================== THEME VARIABLES (SINKRON DENGAN LOGIN/MARKET) ===================== */
        :root{
          --bg-body:#050b1f;
          --text-main:#e5e7eb;
        ...
        /* 🔆 KARTU GLASS SUPER TERANG UNTUK LOGO */
        .visual-card{
            position:relative;
            width:100%;
            max-width:480px;
        ...
        /* checkbox animasi sama seperti login */
        .check{
            cursor:pointer;
            position:relative;
            width:18px;
...
<script>
    // THEME TOGGLE – sama dengan login (key: kampuStoreTheme)
    (function(){
